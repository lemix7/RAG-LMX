    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 6, width: "100%" }}>
      ...
      <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
        ...
        <input
          ...
          onMouseLeave={(e) => {
            if (!focused) (e.target as HTMLInputElement).style.borderColor = "#1f2228";
          }}
        />
      </div>
      {helpText && (
        ...
        <div style={{ width: "100%", maxWidth: 420, display: "flex", flexDirection: "column", gap: 28 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <InputField label="First name" placeholder="John" value={firstName} onChange={setFirstName} icon={<FeatherUser2 style={{ width: 15, height: 15 }} />} />
              <InputField label="Last name" placeholder="Doe" value={lastName} onChange={setLastName} icon={<FeatherUser2 style={{ width: 15, height: 15 }} />} />
            </div>
            ...
            <InputField label="Password" type="password" placeholder="Create a password" value={password} onChange={setPassword} icon={<FeatherLock style={{ width: 15, height: 15 }} />} helpText="Min 8 chars · one uppercase · one number" />
          ...
          <p style={{ fontSize: 13, fontFamily: FONT, letterSpacing: "-0.025em", color: "#7d8187", textAlign: "center", margin: 0 }}>
            ...
            <button type="button" onClick={() => router.push("/login")} style={{ background: "none", border: "none", color: "#ffffff", cursor: "pointer", fontSize: "inherit", fontFamily: "inherit", letterSpacing: "inherit", textDecoration: "underline", textUnderlineOffset: 3, padding: 0 }}>
              Log in
            </button>
          </p>
        </div>
